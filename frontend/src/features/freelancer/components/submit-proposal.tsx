    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <div className="flex justify-center w-full">
          <Button className="group relative overflow-hidden bg-gradient-to-r from-[#FF6B47] to-[#2EC4B6] hover:from-[#E55A38] hover:to-[#23A89C] text-white shadow-md hover:shadow-lg transition-all duration-300 w-auto rounded-lg px-6 py-2 text-sm">
            <div className="absolute inset-0 bg-gradient-to-r from-[#FF8A6F] to-[#5ED4C9] opacity-0 group-hover:opacity-30 transition-opacity duration-300" />
